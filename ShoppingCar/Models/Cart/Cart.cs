...
{
    //儲存一群CartItem，Cart類別就是我們購物車的主要類別
    [Serializable]//可序列化
    public class Cart : IEnumerable<CartItem>
    {
        ...
        public bool AddProduct(int ProductId)
        {
            ...
            #region 判斷相同Id的CartItem是否已經存在購物車內
            if (findItem == default(Models.Cart.CartItem))
            {
                using (Models.ShoppingCarEntities db = new ShoppingCarEntities())
                {
        ...
        #region 新增一筆Product，使用Product物件
        ...
        #region 移除一筆Product，使用ProductId
        ...
        #region 將購物車商品轉成OrderDetail的List
